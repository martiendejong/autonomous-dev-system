...
- **Deployment:**
  ...
  - **Frontend Path:** `C:\inetpub\YOUR_APP\www`
  - **App Pool:** VaultPool
  - **Production URL:** https://YOUR_APP.YOUR_DOMAIN.com
...
config = {
    ...
    "ssh_pass": "YOUR_PASSWORD",  # From PROJECT_MASTER_MAP
    "remote_backend_path": "C:\\inetpub\\vault\\backend",
    "remote_frontend_path": "C:\\inetpub\\vault\\www",
    "app_pool": "VaultPool",
    "production_url": "https://YOUR_APP.YOUR_DOMAIN.com"
}
```
...
[2/6] Creating backup...
  [OK] Backup created: C:\inetpub\YOUR_APP\backend_backup_20260311_143022
...
[6/6] Health check...
  ...
  [OK] Health check passed: https://YOUR_APP.YOUR_DOMAIN.com/health
...
App Pool: VaultPool
Production URL: https://YOUR_APP.YOUR_DOMAIN.com
Backup: C:\inetpub\YOUR_APP\backend_backup_20260311_143022
Status: SUCCESS
================================================================================
```
...
2. Test SSH manually: `ssh administrator@YOUR_SERVER_IP`
...
4. Test endpoint manually: `curl https://YOUR_APP.YOUR_DOMAIN.com/health`
...
2. Check folder permissions: `icacls C:\inetpub\YOUR_APP\backend`
3. Grant permissions if needed:
   ```powershell
   icacls "C:\inetpub\YOUR_APP\backend" /grant "IIS_IUSRS:(OI)(CI)F" /T
   ```
